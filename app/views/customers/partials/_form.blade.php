            ...
            <div class='col-xs-6'>
                <!-- <div class="form-group floating-label-form-group">
                    ...
                    <div class="input-group col-xs-6">
                        ...
                        {{ Form::text('addr1', null, ['class' => 'form-control input-sm floatlabel']) }}
                    </div>
                </div>
                <div class="form-group floating-label-form-group">
                    ...
                    <div class="input-group col-xs-6">
                        <span class="input-group-addon"><i class="fa fa-home fa-fw"></i></span>
                        {{ Form::text('addr2', null, ['class' => 'form-control input-sm floatlabel']) }}
                    </div>
                </div>
                <div class="form-group floating-label-form-group">
                    ...
                    <div class="input-group col-xs-6">
                        <span class="input-group-addon"><i class="fa fa-home fa-fw"></i></span>
                        {{ Form::text('city', null, ['class' => 'form-control input-sm floatlabel']) }}
                    </div>
                </div>
                <div class="form-group floating-label-form-group">
                    ...
                    <div class="input-group col-xs-6">
                        <span class="input-group-addon"><i class="fa fa-home fa-fw"></i></span>
                        {{ Form::text('state', null, ['class' => 'form-control input-sm floatlabel']) }}
                    </div>
                </div>
                <div class="form-group floating-label-form-group">
                    ...
                    <div class="input-group col-xs-6">
                        <span class="input-group-addon"><i class="fa fa-home fa-fw"></i></span>
                        {{ Form::text('postal_code', null, ['class' => 'form-control input-sm floatlabel']) }}
                    </div>
                </div> -->
