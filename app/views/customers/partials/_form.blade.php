            <div class='col-xs-9'>
                <div class="form-group floating-label-form-group">
                    ...
                    <div class="input-group col-xs-6">
                        ...
                        {{ Form::text('first_name', null, ['class' => 'form-control input-sm input-sm-reqd floatlabel', 'placeholder' => 'First Name', 'data-label' => 'Please enter your first (given) name.']) }}
                    </div>
                </div>                
                <div class="form-group floating-label-form-group">
                    ...
                    <div class="input-group col-xs-6">
                        ...
                        <span class="input-group-addon"><i class="fa fa-user fa-fw"></i></span>
                        {{ Form::text('last_name', null, ['class' => 'form-control input-sm input-sm-reqd floatlabel', 'placeholder' => 'Last Name', 'data-label' => 'Please enter your last name (surname).']) }}
                    </div>
                </div>                
                <div class="form-group floating-label-form-group">
                ...
                <div class="form-group floating-label-form-group">
                    ...
                    <div class="input-group col-xs-6">
                        ...
                        {{ Form::password('password', ['class' => 'form-control input-sm input-sm-reqd floatlabel', 'placeholder' => 'Password']) }}
                    </div>
                </div>
                <div class="form-group floating-label-form-group">
                    ...
                    <div class="input-group col-xs-6">
                        ...
                        <span class="input-group-addon"><i class="fa fa-key fa-fw"></i></span>
                        {{ Form::password('password_confirmation', ['class' => 'form-control input-sm input-sm-reqd floatlabel', 'placeholder' => 'Confirm Password']) }}
                    </div>
                </div>
                <div class="form-group floating-label-form-group">
