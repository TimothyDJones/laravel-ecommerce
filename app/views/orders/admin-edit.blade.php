@section('main')
    ...
    {{ Form::model($order, array('route' => array('admin-order-update', $order->customer->id, $order->id),
        ...
        <div class="row">                
            {{ Form::submit($submit_button_label, array('class' => 'btn btn-primary btn-sm')) }}
        </div>
        ...
        <div class="row">
        {{ Form::submit($submit_button_label, array('class' => 'btn btn-primary btn-sm pull-right',)) }}
        </div>
