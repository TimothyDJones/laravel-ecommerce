            <div class='col-xs-9'>
                ...
                @endif
                <div class="form-group floating-label-form-group">
                    {{ Form::label('home_phone', 'Home Phone', array('class' => 'control-label control-label-reqd col-xs-5')) }}
                    <div class="input-group col-xs-6">
                        ...
                        {{ Form::text('home_phone', null, array('class' => 'form-control input-sm floatlabel', 'placeholder' => 'Home Phone')) }}
                    </div>
                </div>
                <div class="form-group floating-label-form-group">
                    {{ Form::label('cell_phone', 'Cell Phone', array('class' => 'control-label col-xs-5')) }}
                    <div class="input-group col-xs-6">
                        ...
                        {{ Form::text('cell_phone', null, array('class' => 'form-control input-sm floatlabel', 'placeholder' => 'Cell Phone')) }}
                    </div>
                </div>
